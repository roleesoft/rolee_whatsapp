...
import {globalOptions, login, logout, rolee_whatsappFooter} from "./whatsapp";
import {listGroups, me, mutateGroup, sendFile, sendImage, sendLocation, sendMessage, sendPoll} from "./commands";
import {bootstrap} from 'global-agent';

const packageJson = require('../package.json');

program.name('rolee_whatsapp').version(packageJson.version);
...
program.on('option:cache', (folder) => process.env.ROLEE_WHATSAPP_CACHE_FOLDER = folder);
