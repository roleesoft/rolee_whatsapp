...
commander_1.program.name('rolee_whatsapp').version(packageJson.version);
...
commander_1.program.on('option:cache', (folder) => process.env.ROLEE_WHATSAPP_CACHE_FOLDER = folder);
...
${whatsapp_1.rolee_whatsappFooter}`);
